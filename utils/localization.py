TEXTS = {
    # --- TÜRKÇE (TR) ---
    "TR": {
        "GAME_TITLE": "KRONOS PROTOKOLU",
        "GAME_SUBTITLE": "Zaman Dongusu Girisimi",
        "START_GAME": "OYUNU BASLAT",
        "LEVELS": "BOLUMLER",
        "QUIT": "CIKIS",
        "BACK": "< GERI",
        "SELECT_LEVEL": "BOLUM SEC",
        "PAUSED": "DURAKLATILDI",
        "RESUME": "DEVAM ET",
        "MAIN_MENU": "ANA MENU",
        "LEVEL_SELECT": "BOLUM SECIMI",
        "LEVEL": "BOLUM",
        "TIME": "SURE",
        "LEVEL_COMPLETE": "BOLUM TAMAMLANDI!",
        "PRESS_SPACE": "Devam: [BOSLUK]",
        "PARADOX": "PARADOKS!",
        "PRESS_R": "Tekrar: [R]",
        "FULLSCREEN_TIP": "[F]: Tam Ekran / [ESC]: Menu",
        "SIMULATION_COMPLETE": "SIMULASYON TAMAMLANDI",
        "LANGUAGE": "DIL: TURKCE",
        "INTRO_TITLE": "KRONOS PROTOKOLU",
        "INTRO_STORY": "Yil 2084. Denek 404.\nBilinc yuklendi.\n\nAmac: Gecmisinle isbirligi yap.\nBasarisizlik sadece yeni bir baslangic.",
    ...
    # --- İNGİLİZCE (EN) ---
    "EN": {
        "GAME_TITLE": "KRONOS PROTOCOL",
        "GAME_SUBTITLE": "Time-Loop Initiative",
        ...
        "PRESS_SPACE": "Continue: [SPACE]",
        "PARADOX": "PARADOX!",
        "PRESS_R": "Retry: [R]",
        "FULLSCREEN_TIP": "[F]: Fullscreen / [ESC]: Menu",
        "SIMULATION_COMPLETE": "SIMULATION COMPLETE",
        "LANGUAGE": "LANGUAGE: ENGLISH",
        "INTRO_TITLE": "KRONOS PROTOCOL",
        "INTRO_STORY": "Year 2084. Subject 404.\nConsciousness uploaded.\n\nGoal: Cooperate with your past self.\nFailure is just a new beginning.",
    ...
    "DE": {
        ...
        "PRESS_SPACE": "Weiter: [LEERTASTE]",
        "PARADOX": "PARADOXON!",
        "PRESS_R": "Neustart: [R]",
        "FULLSCREEN_TIP": "[F]: Vollbild / [ESC]: Menu",
        "SIMULATION_COMPLETE": "SIMULATION BEENDET",
        "LANGUAGE": "SPRACHE: DEUTSCH",
        "INTRO_TITLE": "KRONOS PROTOKOLL",
        ...
        "S3": ["KAPITEL 3: BINARE LOGIK", "", "Blaues Sicherheitsprotokoll.", "Verwalte zwei Zeitlinien.", "Ziel: Nutze beide Systeme."],
    },
    ...
    "FR": {
        ...
        "PRESS_SPACE": "Continuer: [ESPACE]",
        "PARADOX": "PARADOXE!",
        "PRESS_R": "Reessayer: [R]",
        "FULLSCREEN_TIP": "[F]: Plein Ecran / [ESC]: Menu",
        "SIMULATION_COMPLETE": "SIMULATION TERMINEE",
        "LANGUAGE": "LANGUE: FRANCAIS",
        "INTRO_TITLE": "PROTOCOLE KRONOS",
        ...
        "S3": ["CHAPITRE 3: LOGIQUE BINAIRE", "", "Protocole Bleu.", "Gerez deux lignes.", "Objectif: Utilisez les deux systemes."],
    },
    ...
    "ES": {
        ...
        "PRESS_SPACE": "Continuar: [ESPACIO]",
        "PARADOX": "PARADOJA!",
        "PRESS_R": "Reintentar: [R]",
        "FULLSCREEN_TIP": "[F]: Pantalla Completa / [ESC]: Menu",
        "SIMULATION_COMPLETE": "SIMULACION COMPLETA",
        "LANGUAGE": "IDIOMA: ESPANOL",
        "INTRO_TITLE": "PROTOCOLO KRONOS",
        ...
        "S3": ["CAPITULO 3: LOGICA BINARIA", "", "Protocolo Azul.", "Gestiona dos lineas.", "Objetivo: Usa ambos sistemas."],
    }
}
